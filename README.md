...
- **싱글플레이**: 10단계 × 3문제 (30문제), TOP10 랭킹 등록
...
- **완료 기준:** 30문제 종료 → 등급 판정 → 재시작까지 한 사이클 완료
...
- **완료 기준:** 공개 URL에서 싱글플레이 30문제 + TOP10 랭킹 동작
